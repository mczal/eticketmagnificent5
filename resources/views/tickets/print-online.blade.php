...
<img src="{{ $barcode }}" alt="Barcode here" style="position: absolute; right: 85px; top: 230px; width: 270px ; height:80px; z-index:0;"/>
<span style="position: absolute; left: 530px; top: 343.68px; font-size:15px; font-weight:bold; z-index:3; ">{{  $ticket->unique_code }}</span>
